/**
 * Plantillas HTML para los emails transaccionales de SUN-RUNERS.
 *
 * Diseño: profesional cálido, paleta de la marca.
 *   - Background: #F7F5EF (off-white warm)
 *   - Texto: #0F100C (near-black warm)
 *   - Acento: #B8702E (amber)
 *
 * Las plantillas son strings HTML puros (sin JSX) para que se envíen
 * tal cual al API de Brevo. Esto es estándar en email transaccional
 * — los clientes de email (Gmail, Outlook) no soportan React/CSS moderno,
 * así que usamos HTML tabular + estilos inline.
 */
 ...
 * Contenido: confirmación de recepción, qué sigue, WhatsApp directo.
 */
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-radius:12px;overflow:hidden;border:1px solid #DDD6C5;max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding:40px;">
              <h1 style="margin:0 0 24px 0;font-size:26px;font-weight:500;letter-spacing:-0.02em;color:#0F100C;line-height:1.2;">
              ...
              <!-- Bloque "qué sigue" -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F7F5EF;border-radius:8px;padding:20px;margin-bottom:32px;">
                <tr>
                  <td style="padding:20px;">
                    <p style="margin:0 0 12px 0;font-size:12px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;color:#B8702E;">
                      Qué sigue
                    </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                <tr>
                  <td align="center" style="background-color:#0F100C;border-radius:999px;padding:16px 24px;">
                    <a href="${escapeHtml(whatsappLink)}" style="display:block;color:#F7F5EF;text-decoration:none;font-size:15px;font-weight:500;">
                      Escribir por WhatsApp
                    </a>
                  </td>
                </tr>
              </table>
              <p style="margin:0 0 32px 0;font-size:13px;color:#6A655A;text-align:center;">
                Si necesitas atención urgente, escríbenos directamente.
              </p>
              `
                  : ""
              }

              <p style="margin:0;font-size:16px;line-height:1.65;color:#4A463E;">
                Gracias por confiar en nosotros.
              </p>

              <p style="margin:24px 0 0 0;font-size:15px;color:#0F100C;">
                <strong>Equipo SUN-RUNERS</strong>
              </p>
            </td>
          </tr>
          ...
          <!-- Footer -->
          <tr>
            <td style="padding:24px 40px;background-color:#F7F5EF;border-top:1px solid #ECE7DA;">
              <p style="margin:0 0 8px 0;font-size:12px;color:#6A655A;line-height:1.5;">
                ${escapeHtml(COMPANY.legalName)} · ${escapeHtml(COMPANY.city)}
              </p>
        ...
        <p style="margin:20px 0 0 0;font-size:11px;color:#9A9485;text-align:center;">
          Este email fue enviado automáticamente desde el formulario de contacto de SUN-RUNERS.
        </p>
      </td>
    </tr>
  </table>
...
interface EngineerNotificationEmailData {
  // Datos del ingeniero (privados)
  engineerName: string;
  engineerEmail: string;
  // Datos del cliente (de la solicitud)
...
/**
 * Email de notificación interna al ingeniero asignado.
 * Tono: informativo, directo, con todos los datos del cliente.
 * Se envía al ingeniero y en copia al email central de la compañía.
 */
        ...
        <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-radius:12px;overflow:hidden;border:1px solid #DDD6C5;max-width:640px;width:100%;">
          ...
          <tr>
            <td style="padding:24px 32px;background-color:#0F100C;color:#F7F5EF;">
              <span style="font-size:11px;font-weight:600;letter-spacing:0.18em;text-transform:uppercase;color:#B8702E;">
                Notificación interna · SUN-RUNERS
              </span>
              <h1 style="margin:8px 0 0 0;font-size:20px;font-weight:500;letter-spacing:-0.02em;color:#F7F5EF;">
                Nueva solicitud asignada
              </h1>
              <p style="margin:6px 0 0 0;font-size:13px;color:#A8A395;font-family:monospace;">
                #${escapeHtml(requestId.slice(-8).toUpperCase())}
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F7F5EF;border-radius:8px;padding:16px 20px;margin-bottom:28px;">
                <tr>
                  <td style="padding:16px 20px;">
                    <p style="margin:0 0 8px 0;font-size:12px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;color:#B8702E;">
                      Asignación
                    </p>
              ...
              <!-- Datos del cliente -->
              <h2 style="margin:0 0 16px 0;font-size:13px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;color:#6A655A;">
                Datos del cliente
              </h2>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;color:#4A463E;vertical-align:top;width:120px;">
                    <strong style="color:#0F100C;">Nombre</strong>
                  </td>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;color:#0F100C;">
                    ${escapeHtml(client.name)}
                  </td>
                </tr>
                <tr>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;color:#4A463E;vertical-align:top;">
                    <strong style="color:#0F100C;">Email</strong>
                  </td>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;">
                    <a href="mailto:${escapeHtml(client.email)}" style="color:#B8702E;text-decoration:none;">${escapeHtml(client.email)}</a>
                  </td>
                </tr>
                <tr>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;color:#4A463E;vertical-align:top;">
                    <strong style="color:#0F100C;">Teléfono</strong>
                  </td>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;color:#0F100C;">
                    <a href="tel:${escapeHtml(client.phone.replace(/\\s/g, ""))}" style="color:#B8702E;text-decoration:none;">${escapeHtml(client.phone)}</a>
                  </td>
                </tr>
                <tr>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;color:#4A463E;vertical-align:top;">
                    <strong style="color:#0F100C;">Dirección</strong>
                  </td>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;color:#0F100C;">
                ...
                <tr>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;color:#4A463E;vertical-align:top;">
                    <strong style="color:#0F100C;">Servicio</strong>
                  </td>
                  <td style="padding:8px 0;border-bottom:1px solid #ECE7DA;font-size:14px;color:#0F100C;">
                ...
                <tr>
                  <td style="padding:8px 0;font-size:14px;color:#4A463E;vertical-align:top;">
                    <strong style="color:#0F100C;">Canal preferido</strong>
                  </td>
                  <td style="padding:8px 0;font-size:14px;color:#0F100C;text-transform:capitalize;">
                    ${escapeHtml(client.preferredChannel)}
                  </td>
                </tr>
              </table>

              <!-- Mensaje del cliente -->
              <h2 style="margin:0 0 12px 0;font-size:13px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;color:#6A655A;">
                Mensaje del cliente
              </h2>
              <blockquote style="margin:0 0 28px 0;padding:16px 20px;background-color:#F7F5EF;border-left:3px solid #B8702E;font-size:14px;line-height:1.65;color:#0F100C;font-style:italic;">
                ${escapeHtml(client.message)}
              </blockquote>

              <!-- Acción -->
              <p style="margin:0;font-size:13px;color:#6A655A;line-height:1.5;">
                Contacta al cliente por el canal preferido en menos de 24 horas hábiles.
                Esta solicitud quedó registrada en el sistema con estado <strong style="color:#0F100C;">nuevo</strong>.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:20px 32px;background-color:#F7F5EF;border-top:1px solid #ECE7DA;">
              <p style="margin:0;font-size:11px;color:#6A655A;line-height:1.5;">
                Email automático generado por el sistema de automatización SUN-RUNERS.
