...
/**
 * HELORA — Ingeniería en energía, automatización y clima.
 *
 * Manifiesto de marca:
 *  - Nombre abstracto: HELORA (de Helios + ora = "era del sol").
 *  - Sin alusiones literales a "eléctrico", "solar", "volt", "team".
 *  - Identidad visual: monograma H formado por dos flechas
 *    ascendentes que sugieren flujo de energía y conexión.
 */

export const COMPANY = {
  name: "HELORA",
  legalName: "HELORA — Ingeniería en Energía",
